...
class SignUpViewController: UIViewController, UITextFieldDelegate {
    ...
    @objc func registerClick(){
        ...
        self.controller.registerUser(email: self.emailInput.text!, password: self.passwordInput.text!, name: self.firstnameInput.text!, phone: self.phoneInput.text!) {(success) in
            if(success){
